...
def happy():
    # picks a random number 1-3 then chooses a quote based on that number
        ...
        if randomnum == 1:
            ...
            print ("“The true secret of happiness lies in the taking a genuine interest in all the details of daily life.” – William Morris")
        else:
            print ("“The greatest happiness you can have is knowing that you do not necessarily require happiness.” – William Saroyan")
def sad():
    # picks a random number 1-3 then chooses a quote based on that number
        randomnum = random.randint(1,3)
        if randomnum == 1:
            ...
            print ("“We can’t control the world. We can only (barely) control our own reactions to it. Happiness is largely a choice, not a right or entitlement.” – David C. Hill")
...
def inspired():
    # picks a random number 1-3 then chooses a quote based on that number
        ...
        if randomnum == 1:
            ...
            print ("“I can't change the direction of the wind, but I can adjust my sails to always reach my destination.” - Jimmy Dean")
        else:
